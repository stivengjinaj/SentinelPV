...
class Model(nn.Module):
    def __init__(self, dim=374, depth=12, heads=8, mlp_dim=374, dim_head = 32, ref = 4, dropout = 0., emb_dropout = 0.,args=None):
        super().__init__()
    ...
    def forward(self, x, t, time, row_indices, col_indices, sparse_sensor_field):
