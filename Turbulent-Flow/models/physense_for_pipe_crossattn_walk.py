...
class Model(nn.Module):
    def __init__(self, patch_size=4, dim=374, depth=8, heads=8, mlp_dim=374, pool = 'cls', in_channels = 1, out_channels=1, dim_head = 32, dropout = 0., emb_dropout = 0.,args=None):
        super().__init__()
        image_height, image_width = (128, 48)
    ...
    def forward(self, x, t, row_indices, col_indices, sparse_sensor_field, sparse_pos):
